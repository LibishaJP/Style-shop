...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        "accordion-down": "accordion-down 0.3s var(--animation-smooth)",
        "accordion-up": "accordion-up 0.3s var(--animation-smooth)",
        "fade-in": "fade-in 0.5s var(--animation-smooth)",
        "slide-up": "slide-up 0.4s var(--animation-spring)",
        "scale-in": "scale-in 0.3s var(--animation-spring)",
